...
return [
    ...
    */
    ...
    | des attributs donnés en utilisant la convention "attribute.rule" pour
    | nommer les lignes. Cela vous permet de personnaliser facilement un
    | message pour une règle spécifique sur un champ particulier.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour remplacer les noms d’attributs
    | par quelque chose de plus lisible pour l’utilisateur, comme “Adresse e-mail”
    | au lieu de “email”. Cela rend les messages plus clairs.
    |
    */
